...
class objectDetect():
    ...
    def __init__(self, withoutservo, config):
        ...
        PATH_TO_CKPT = './src/vision/vision_pkg/submodules/nets/rede/frozen_inference_graph.pb'

        # List of the strings that is used to add correct label for each box.
        PATH_TO_LABELS = os.path.join('./src/vision/vision_pkg/submodules/nets/rede/object-detection.pbtxt')
