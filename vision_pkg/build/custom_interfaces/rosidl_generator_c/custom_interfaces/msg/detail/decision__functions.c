...
{
  custom_interfaces__msg__Decision * msg = (custom_interfaces__msg__Decision *)malloc(sizeof(custom_interfaces__msg__Decision));
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__msg__Decision__Sequence__init(custom_interfaces__msg__Decision__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__msg__Decision *)calloc(size, sizeof(custom_interfaces__msg__Decision));
    if (!data) {
      return false;
    }
...
{
  custom_interfaces__msg__Decision__Sequence * array = (custom_interfaces__msg__Decision__Sequence *)malloc(sizeof(custom_interfaces__msg__Decision__Sequence));
  if (!array) {
    return NULL;
  }
