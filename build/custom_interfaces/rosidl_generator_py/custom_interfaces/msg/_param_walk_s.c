...
bool custom_interfaces__msg__param_walk__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._param_walk.ParamWalk", full_classname_dest, 43) == 0);
  }
  custom_interfaces__msg__ParamWalk * ros_message = _ros_message;
  {  // walk
...
PyObject * custom_interfaces__msg__param_walk__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._param_walk");
