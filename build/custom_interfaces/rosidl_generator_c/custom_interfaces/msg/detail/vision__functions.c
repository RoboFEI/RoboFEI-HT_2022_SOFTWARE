...
{
  custom_interfaces__msg__Vision * msg = (custom_interfaces__msg__Vision *)malloc(sizeof(custom_interfaces__msg__Vision));
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__msg__Vision__Sequence__init(custom_interfaces__msg__Vision__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__msg__Vision *)calloc(size, sizeof(custom_interfaces__msg__Vision));
    if (!data) {
      return false;
    }
...
{
  custom_interfaces__msg__Vision__Sequence * array = (custom_interfaces__msg__Vision__Sequence *)malloc(sizeof(custom_interfaces__msg__Vision__Sequence));
  if (!array) {
    return NULL;
  }
