...
{
  custom_interfaces__msg__SetPosition * msg = (custom_interfaces__msg__SetPosition *)malloc(sizeof(custom_interfaces__msg__SetPosition));
  if (!msg) {
    return NULL;
  }
...
custom_interfaces__msg__SetPosition__Sequence__init(custom_interfaces__msg__SetPosition__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (custom_interfaces__msg__SetPosition *)calloc(size, sizeof(custom_interfaces__msg__SetPosition));
    if (!data) {
      return false;
    }
...
{
  custom_interfaces__msg__SetPosition__Sequence * array = (custom_interfaces__msg__SetPosition__Sequence *)malloc(sizeof(custom_interfaces__msg__SetPosition__Sequence));
  if (!array) {
    return NULL;
  }
