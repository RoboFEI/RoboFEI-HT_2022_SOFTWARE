...
{
  dynamixel_sdk_custom_interfaces__msg__ParamWalk * msg = (dynamixel_sdk_custom_interfaces__msg__ParamWalk *)malloc(sizeof(dynamixel_sdk_custom_interfaces__msg__ParamWalk));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_custom_interfaces__msg__ParamWalk));
  bool success = dynamixel_sdk_custom_interfaces__msg__ParamWalk__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    dynamixel_sdk_custom_interfaces__msg__ParamWalk__fini(msg);
  }
  free(msg);
}
...
dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence__init(dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence * array, size_t size)
{
  ...
  dynamixel_sdk_custom_interfaces__msg__ParamWalk * data = NULL;
  if (size) {
    data = (dynamixel_sdk_custom_interfaces__msg__ParamWalk *)calloc(size, sizeof(dynamixel_sdk_custom_interfaces__msg__ParamWalk));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_custom_interfaces__msg__ParamWalk__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_sdk_custom_interfaces__msg__ParamWalk__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence__fini(dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_custom_interfaces__msg__ParamWalk__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence * array = (dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence *)malloc(sizeof(dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    dynamixel_sdk_custom_interfaces__msg__ParamWalk__Sequence__fini(array);
  }
  free(array);
}
