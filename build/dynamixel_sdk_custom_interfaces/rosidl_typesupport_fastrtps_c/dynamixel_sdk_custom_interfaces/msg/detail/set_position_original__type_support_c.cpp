...
#include "dynamixel_sdk_custom_interfaces/msg/detail/set_position_original__rosidl_typesupport_fastrtps_c.h"
...
using _SetPositionOriginal__ros_msg_type = dynamixel_sdk_custom_interfaces__msg__SetPositionOriginal;
...
size_t get_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionOriginal(
  const void * untyped_ros_message,
...
static uint32_t _SetPositionOriginal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionOriginal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_sdk_custom_interfaces
size_t max_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionOriginal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionOriginal(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_sdk_custom_interfaces, msg, SetPositionOriginal)() {
