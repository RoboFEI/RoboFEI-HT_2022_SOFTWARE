...
{
  new (message_memory) dynamixel_sdk_custom_interfaces::msg::Walk(_init);
}

void Walk_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::msg::Walk *>(message_memory);
  typed_message->~Walk();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Walk_message_member_array[1] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces::msg::Walk, walk),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Walk_message_members = {
  ...
  "Walk",  // message name
  1,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces::msg::Walk),
...
{
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Walk_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, msg, Walk)() {
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Walk_message_type_support_handle;
}
