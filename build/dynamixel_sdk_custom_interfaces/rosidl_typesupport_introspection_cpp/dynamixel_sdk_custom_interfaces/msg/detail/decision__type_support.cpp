...
{
  new (message_memory) dynamixel_sdk_custom_interfaces::msg::Decision(_init);
}

void Decision_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::msg::Decision *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Decision_message_member_array[1] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces::msg::Decision, decision),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Decision_message_members = {
  ...
  1,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces::msg::Decision),
...
{
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Decision_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, msg, Decision)() {
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Decision_message_type_support_handle;
}
