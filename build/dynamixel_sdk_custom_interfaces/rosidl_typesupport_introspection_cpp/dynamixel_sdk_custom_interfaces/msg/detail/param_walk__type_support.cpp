...
{
  new (message_memory) dynamixel_sdk_custom_interfaces::msg::ParamWalk(_init);
}

void ParamWalk_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::msg::ParamWalk *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ParamWalk_message_member_array[3] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces::msg::ParamWalk, walk),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces::msg::ParamWalk, sidle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces::msg::ParamWalk, turn),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ParamWalk_message_members = {
  ...
  3,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces::msg::ParamWalk),
...
{
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::ParamWalk_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, msg, ParamWalk)() {
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::ParamWalk_message_type_support_handle;
}
