...
#include <stddef.h>
#include "dynamixel_sdk_custom_interfaces/msg/detail/param_walk__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dynamixel_sdk_custom_interfaces__msg__ParamWalk__init(message_memory);
}

void ParamWalk__rosidl_typesupport_introspection_c__ParamWalk_fini_function(void * message_memory)
{
  dynamixel_sdk_custom_interfaces__msg__ParamWalk__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ParamWalk__rosidl_typesupport_introspection_c__ParamWalk_message_member_array[3] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces__msg__ParamWalk, walk),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces__msg__ParamWalk, sidle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces__msg__ParamWalk, turn),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ParamWalk__rosidl_typesupport_introspection_c__ParamWalk_message_members = {
  ...
  3,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces__msg__ParamWalk),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_sdk_custom_interfaces, msg, ParamWalk)() {
