...
#include <stddef.h>
#include "dynamixel_sdk_custom_interfaces/msg/detail/decision__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dynamixel_sdk_custom_interfaces__msg__Decision__init(message_memory);
}

void Decision__rosidl_typesupport_introspection_c__Decision_fini_function(void * message_memory)
{
  dynamixel_sdk_custom_interfaces__msg__Decision__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Decision__rosidl_typesupport_introspection_c__Decision_message_member_array[1] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces__msg__Decision, decision),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Decision__rosidl_typesupport_introspection_c__Decision_message_members = {
  ...
  1,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces__msg__Decision),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_sdk_custom_interfaces, msg, Decision)() {
