...
#include <stddef.h>
#include "custom_interfaces_vision/msg/detail/decision__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces_vision__msg__Decision__init(message_memory);
}

void Decision__rosidl_typesupport_introspection_c__Decision_fini_function(void * message_memory)
{
  custom_interfaces_vision__msg__Decision__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Decision__rosidl_typesupport_introspection_c__Decision_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces_vision__msg__Decision, decision),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Decision__rosidl_typesupport_introspection_c__Decision_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces_vision__msg__Decision),
