...
#ifndef CUSTOM_INTERFACES_VISION__MSG__DETAIL__HUMANOID_LEAGUE_MSGS__STRUCT_HPP_
#define CUSTOM_INTERFACES_VISION__MSG__DETAIL__HUMANOID_LEAGUE_MSGS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__custom_interfaces_vision__msg__HumanoidLeagueMsgs __attribute__((deprecated))
#else
# define DEPRECATED__custom_interfaces_vision__msg__HumanoidLeagueMsgs __declspec(deprecated)
#endif
...
struct HumanoidLeagueMsgs_
{
  ...
  // pointer types
  using RawPtr =
    custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> *;
  using ConstRawPtr =
    const custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__custom_interfaces_vision__msg__HumanoidLeagueMsgs
    std::shared_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__custom_interfaces_vision__msg__HumanoidLeagueMsgs
    std::shared_ptr<custom_interfaces_vision::msg::HumanoidLeagueMsgs_<ContainerAllocator> const>
...
using HumanoidLeagueMsgs =
  custom_interfaces_vision::msg::HumanoidLeagueMsgs_<std::allocator<void>>;
...
#endif  // CUSTOM_INTERFACES_VISION__MSG__DETAIL__HUMANOID_LEAGUE_MSGS__STRUCT_HPP_
