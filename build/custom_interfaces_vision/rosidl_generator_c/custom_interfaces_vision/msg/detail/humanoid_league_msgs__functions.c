...
custom_interfaces_vision__msg__HumanoidLeagueMsgs__init(custom_interfaces_vision__msg__HumanoidLeagueMsgs * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    custom_interfaces_vision__msg__HumanoidLeagueMsgs__fini(msg);
    return false;
  }
  // game_state
  // secondary_state
...
{
  custom_interfaces_vision__msg__HumanoidLeagueMsgs * msg = (custom_interfaces_vision__msg__HumanoidLeagueMsgs *)malloc(sizeof(custom_interfaces_vision__msg__HumanoidLeagueMsgs));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_interfaces_vision__msg__HumanoidLeagueMsgs));
  bool success = custom_interfaces_vision__msg__HumanoidLeagueMsgs__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence__init(custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence * array, size_t size)
{
  ...
  custom_interfaces_vision__msg__HumanoidLeagueMsgs * data = NULL;
  if (size) {
    data = (custom_interfaces_vision__msg__HumanoidLeagueMsgs *)calloc(size, sizeof(custom_interfaces_vision__msg__HumanoidLeagueMsgs));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_interfaces_vision__msg__HumanoidLeagueMsgs__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_interfaces_vision__msg__HumanoidLeagueMsgs__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence__fini(custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_interfaces_vision__msg__HumanoidLeagueMsgs__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence * array = (custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence *)malloc(sizeof(custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    custom_interfaces_vision__msg__HumanoidLeagueMsgs__Sequence__fini(array);
  }
  free(array);
}
