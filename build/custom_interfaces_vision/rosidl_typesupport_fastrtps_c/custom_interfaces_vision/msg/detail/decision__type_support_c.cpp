...
#include "custom_interfaces_vision/msg/detail/decision__rosidl_typesupport_fastrtps_c.h"
...
using _Decision__ros_msg_type = custom_interfaces_vision__msg__Decision;
...
size_t get_serialized_size_custom_interfaces_vision__msg__Decision(
  const void * untyped_ros_message,
...
static uint32_t _Decision__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces_vision__msg__Decision(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces_vision
size_t max_serialized_size_custom_interfaces_vision__msg__Decision(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interfaces_vision__msg__Decision(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces_vision, msg, Decision)() {
