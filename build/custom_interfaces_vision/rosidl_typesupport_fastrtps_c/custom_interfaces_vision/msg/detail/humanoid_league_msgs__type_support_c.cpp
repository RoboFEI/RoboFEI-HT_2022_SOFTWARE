...
#include "custom_interfaces_vision/msg/detail/humanoid_league_msgs__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_custom_interfaces_vision
...
using _HumanoidLeagueMsgs__ros_msg_type = custom_interfaces_vision__msg__HumanoidLeagueMsgs;
...
size_t get_serialized_size_custom_interfaces_vision__msg__HumanoidLeagueMsgs(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HumanoidLeagueMsgs__ros_msg_type * ros_message = static_cast<const _HumanoidLeagueMsgs__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HumanoidLeagueMsgs__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces_vision__msg__HumanoidLeagueMsgs(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces_vision
size_t max_serialized_size_custom_interfaces_vision__msg__HumanoidLeagueMsgs(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interfaces_vision__msg__HumanoidLeagueMsgs(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces_vision, msg, HumanoidLeagueMsgs)() {
