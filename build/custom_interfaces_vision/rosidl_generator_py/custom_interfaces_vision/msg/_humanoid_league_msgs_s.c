...
bool custom_interfaces_vision__msg__humanoid_league_msgs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces_vision.msg._humanoid_league_msgs.HumanoidLeagueMsgs", full_classname_dest, 69) == 0);
  }
  custom_interfaces_vision__msg__HumanoidLeagueMsgs * ros_message = _ros_message;
  {  // header
...
PyObject * custom_interfaces_vision__msg__humanoid_league_msgs__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces_vision.msg._humanoid_league_msgs");
