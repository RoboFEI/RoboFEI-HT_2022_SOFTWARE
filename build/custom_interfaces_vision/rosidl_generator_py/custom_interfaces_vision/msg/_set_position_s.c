...
bool custom_interfaces_vision__msg__set_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces_vision.msg._set_position.SetPosition", full_classname_dest, 54) == 0);
  }
  custom_interfaces_vision__msg__SetPosition * ros_message = _ros_message;
  {  // id
...
PyObject * custom_interfaces_vision__msg__set_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces_vision.msg._set_position");
