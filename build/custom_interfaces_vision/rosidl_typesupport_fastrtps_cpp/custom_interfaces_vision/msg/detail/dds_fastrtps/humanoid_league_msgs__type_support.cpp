...
#include "custom_interfaces_vision/msg/detail/humanoid_league_msgs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces_vision::msg::HumanoidLeagueMsgs & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces_vision::msg::HumanoidLeagueMsgs & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const custom_interfaces_vision::msg::HumanoidLeagueMsgs *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces_vision::msg::HumanoidLeagueMsgs *>(
    untyped_ros_message);
...
{
  return &custom_interfaces_vision::msg::typesupport_fastrtps_cpp::_HumanoidLeagueMsgs__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces_vision, msg, HumanoidLeagueMsgs)() {
  return &custom_interfaces_vision::msg::typesupport_fastrtps_cpp::_HumanoidLeagueMsgs__handle;
}
