...
#include "custom_interfaces_vision/msg/detail/decision__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const custom_interfaces_vision::msg::Decision *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces_vision::msg::Decision *>(
    untyped_ros_message);
...
{
  return &custom_interfaces_vision::msg::typesupport_fastrtps_cpp::_Decision__handle;
}
