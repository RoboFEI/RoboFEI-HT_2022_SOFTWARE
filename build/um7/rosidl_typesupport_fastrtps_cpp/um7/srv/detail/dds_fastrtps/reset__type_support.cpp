...
#include "um7/srv/detail/reset__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const um7::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<um7::srv::Reset_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_um7
const rosidl_message_type_support_t *
get_message_type_support_handle<um7::srv::Reset_Request>()
{
  return &um7::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const um7::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<um7::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &um7::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
{
  return &um7::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
