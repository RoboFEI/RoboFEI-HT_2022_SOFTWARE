...
#include "um7/srv/detail/reset__rosidl_typesupport_fastrtps_c.h"
...
#include "um7/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Reset_Request__ros_msg_type = um7__srv__Reset_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_um7
size_t get_serialized_size_um7__srv__Reset_Request(
  const void * untyped_ros_message,
...
static uint32_t _Reset_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_um7__srv__Reset_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_um7
size_t max_serialized_size_um7__srv__Reset_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_um7__srv__Reset_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, um7, srv, Reset_Request)() {
...
using _Reset_Response__ros_msg_type = um7__srv__Reset_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_um7
size_t get_serialized_size_um7__srv__Reset_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Reset_Response__ros_msg_type * ros_message = static_cast<const _Reset_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_um7__srv__Reset_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_um7
size_t max_serialized_size_um7__srv__Reset_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_um7__srv__Reset_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, um7, srv, Reset_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, um7, srv, Reset)() {
