...
bool um7__srv__reset__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("um7.srv._reset.Reset_Request", full_classname_dest, 28) == 0);
  }
  um7__srv__Reset_Request * ros_message = _ros_message;
  {  // zero_gyros
...
PyObject * um7__srv__reset__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("um7.srv._reset");
...
ROSIDL_GENERATOR_C_EXPORT
bool um7__srv__reset__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("um7.srv._reset.Reset_Response", full_classname_dest, 29) == 0);
  }
  um7__srv__Reset_Response * ros_message = _ros_message;
