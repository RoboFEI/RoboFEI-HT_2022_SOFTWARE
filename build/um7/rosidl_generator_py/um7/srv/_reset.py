...
class Metaclass_Reset_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('um7')
        except ImportError:
            import logging
            import traceback
...
class Reset(metaclass=Metaclass_Reset):
    from um7.srv._reset import Reset_Request as Request
    from um7.srv._reset import Reset_Response as Response
