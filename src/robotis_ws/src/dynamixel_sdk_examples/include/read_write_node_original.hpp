...
#ifndef READ_WRITE_NODE_ORIGINAL_HPP_
#define READ_WRITE_NODE_ORIGINAL_HPP_
...
private:
  rclcpp::Subscription<SetPositionOriginal>::SharedPtr set_position_subscriber_;
  rclcpp::Service<GetPosition>::SharedPtr get_position_server_;

  int present_position;
};

#endif  // READ_WRITE_NODE_ORIGINAL_HPP_
