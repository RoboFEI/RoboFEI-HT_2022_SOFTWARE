...
// #ifdef MX28_1024
// #define MOTION_FILE_PATH    "/home/robo/ROS2/walk_test/src/control/Data/motion_1024.bin"
// #else
...
int process()
{
    ...
    // if(Action::LoadFile(filename) == false)
    // {
...
//     if( MotionManager::GetInstance()->Initialize() == 0)
