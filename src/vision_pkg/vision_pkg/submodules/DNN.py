...
class objectDetect():
    ...
    def __init__(self, withoutservo, config):
        ...
        PATH_TO_CKPT = 'src/vision_pkg/vision_pkg/submodules/nets/frozen_inference_graph.pb'

        # List of the strings that is used to add correct label for each box.
        PATH_TO_LABELS = os.path.join('src/vision_pkg/vision_pkg/submodules/nets/object-detection.pbtxt')
