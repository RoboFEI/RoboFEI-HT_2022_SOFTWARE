...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_interfaces.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from custom_interfaces.srv._get_position import GetPosition_Request as Request
    from custom_interfaces.srv._get_position import GetPosition_Response as Response
