...
bool custom_interfaces__msg__set_position_sync__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._set_position_sync.SetPositionSync", full_classname_dest, 56) == 0);
  }
  custom_interfaces__msg__SetPositionSync * ros_message = _ros_message;
  {  // id
...
PyObject * custom_interfaces__msg__set_position_sync__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._set_position_sync");
