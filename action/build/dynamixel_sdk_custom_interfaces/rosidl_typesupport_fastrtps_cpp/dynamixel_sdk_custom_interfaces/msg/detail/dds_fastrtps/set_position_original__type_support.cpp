...
#include "dynamixel_sdk_custom_interfaces/msg/detail/set_position_original__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_sdk_custom_interfaces::msg::SetPositionOriginal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_custom_interfaces::msg::SetPositionOriginal & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::msg::SetPositionOriginal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::msg::SetPositionOriginal *>(
    untyped_ros_message);
...
{
  return &dynamixel_sdk_custom_interfaces::msg::typesupport_fastrtps_cpp::_SetPositionOriginal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, msg, SetPositionOriginal)() {
  return &dynamixel_sdk_custom_interfaces::msg::typesupport_fastrtps_cpp::_SetPositionOriginal__handle;
}
