...
bool dynamixel_sdk_custom_interfaces__msg__set_position_sync__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.msg._set_position_sync.SetPositionSync", full_classname_dest, 70) == 0);
  }
  dynamixel_sdk_custom_interfaces__msg__SetPositionSync * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of SetPositionSync */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.msg._set_position_sync");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPositionSync");
