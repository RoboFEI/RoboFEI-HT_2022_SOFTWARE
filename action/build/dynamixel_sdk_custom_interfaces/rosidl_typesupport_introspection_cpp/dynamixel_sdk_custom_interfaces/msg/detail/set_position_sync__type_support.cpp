...
{
  new (message_memory) dynamixel_sdk_custom_interfaces::msg::SetPositionSync(_init);
}

void SetPositionSync_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dynamixel_sdk_custom_interfaces::msg::SetPositionSync *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPositionSync_message_member_array[2] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces::msg::SetPositionSync, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces::msg::SetPositionSync, position),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPositionSync_message_members = {
  ...
  2,  // number of fields
  sizeof(dynamixel_sdk_custom_interfaces::msg::SetPositionSync),
...
{
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPositionSync_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_custom_interfaces, msg, SetPositionSync)() {
  return &::dynamixel_sdk_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPositionSync_message_type_support_handle;
}
